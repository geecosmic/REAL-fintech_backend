...
urlpatterns = [
    ...
    path('electricity/callback/', electricity_callback, name='electricity-callback'),
    ...
    path('auth/request-password-reset/', RequestPasswordResetView.as_view()),
